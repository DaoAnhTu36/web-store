...
<?= view("Layouts/banner_view.php") ?>
<?= view("Layouts/left_menu_view.php") ?>
<?= view("Layouts/right_menu_view.php") ?>
<!-- <?= view("Layouts/slide_view.php") ?> -->
<?= view("Layouts/panel_header_view.php") ?>
