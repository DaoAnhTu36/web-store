                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
                    <div>
                        ...
                        <div class="widget-body">
                            <form class="form-horizontal" id="form-common" action="<?= base_url('admin/discount-type/update/' . $data['id']); ?>" method="POST" enctype="multipart/form-data">
                                <fieldset>
                                    <legend>Cập nhật loại khuyến mại</legend>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" value="" placeholder="" type="text" id="description" name="description">
                                            <?= $data['description'] ?>
                                            </textarea>
                                        </div>
                                    </div>
